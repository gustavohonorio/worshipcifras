...
def cadastrar(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            nova_cifra = Cifra(nome='nome', wc_artista='wc_artista', genero='genero', cifra='cifra', detalhes='detalhes', tom='tom', capotraste='capotraste', afinacao='afinacao', versao='versao',)
